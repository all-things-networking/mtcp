 ...
 * prototypes that let one .c file call into another. A program is written
 * in the order a reader wants and its calls run in every direction, so the
 * split across files is a presentation choice, not a linkage constraint.
 */
#include <stdbool.h>
#include <stdint.h>
#include <string.h>
